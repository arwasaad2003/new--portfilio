    ...
    $(".progress").each(function(){
        ...
        $this.isInViewport(function(status) {
            if (status === "entered") {
                ...
                $this.toArray("data-progress-ar-left") && $this.find(".ts-progress-value").css("left", $this.attr("data-progress-ar-left"));
            }
        });
    });
...
document.addEventListener("scroll", function () {
  ...
  form.addEventListener('submit', async (event) => {
    ...
    const formspreeURL = 'https://formspree.io/f/myzkjwqj'; // Replace 'your-form-id' with your actual Formspree form ID
